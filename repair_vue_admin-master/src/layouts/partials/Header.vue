...
<div id="header">
  <Row>
    ...
    <div class="logo-info">
      <img class="logo" src="https://www.chendong00.top/weixiu.png" alt="logo">
      <p class="name">宿舍报修系统 <br> <span class="sub"></span></p>
    </div>
    <!-- .logo-info -->
    <IBreadcrumb />
    <!-- IBreadcrumb -->
    ...
    <div class="login-info">
      <Dropdown placement="bottom-end" trigger="click" @on-click="handleDropdown">
        <strong class="user">
          ...
          <!--  -->
          <!-- <img :src="headportraits" style="border-radius: 50%;width:30px;height:30px;"/> -->
          Hi, {{ userName }}
        </strong>
...
export default {
  ...
  mounted() {
    ...
    this.userName = userInfo.nickname || "Null";
    this.headportraits = userInfo.headportraits
